  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white dark:from-blue-900 dark:to-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-12">
        <div className="text-center mb-12">
          ...
          <div className="mt-10">
            <button
              ...
              className="px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white text-lg font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 transform hover:-translate-y-1"
            >
        ...
        {/* File Upload Section */}
        <div id="file-upload-section" className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 mb-12 transition-all duration-300">
          {showFileUpload ? (
            <FileUpload />
          ) : (
            <div className="text-center py-12">
              <h2 className="text-2xl font-semibold text-gray-700 dark:text-gray-200 mb-4">Ready to Analyze Your DNA?</h2>
              <p className="text-gray-500 dark:text-gray-400 mb-6">Click the button above to get started with your free pharmacogenomic analysis</p>
              <button
                onClick={handleGetStarted}
                className="px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-medium rounded-lg shadow-md transition-all duration-200"
              >
                Upload VCF File
              </button>
            </div>
